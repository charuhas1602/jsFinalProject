...
function createHomeClothsSection(data){
  ...
  divSetter.innerHTML=`<div class="card  d-flex flex-column divSetter px-0  border border-dark " >
  <figure class="figcard"><img src="${data.preview}" class="card-img-top rounded-top  " alt="..." style="height:450px;"></figure>
...
accessories.appendChild(divSetter);
